    ...
    LC190 =
        [
            ...
            Fields = {
                ...
                Field("CFOP", 3, "code4"),
                Field("ALIQ_ICMS", 4, "num_pt_4"),
                Field("VL_OPR", 5, "num_pt_2"),
                Field("VL_BC_ICMS", 6, "num_pt_2"),
                Field("VL_ICMS", 7, "num_pt_2"),
                Field("VL_BC_ICMS_ST", 8, "num_pt_2"),
                Field("VL_ICMS_ST", 9, "num_pt_2"),
                Field("VL_RED_BC", 10, "num_pt_2"),
                Field("VL_IPI", 11, "num_pt_2"),
                Field("COD_OBS", 12, "text")
            },
            Derivados = {
                Deriv(
                    "CFOP_DIRECAO_DESC",
